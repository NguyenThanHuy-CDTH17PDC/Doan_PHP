...
@section('main-content')
	<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                	<h1 class="mb-3 header-title">Các gói credit của trò chơi</h1>
                	<a href="{{ route('goi_credit.them_moi')}}" class="btn btn-primary btn-rounded waves-effect waves-light">Thêm gói credit</a>
                	<h5>Danh sách gói credit</h5>
