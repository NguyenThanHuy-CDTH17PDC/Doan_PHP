                ...
                <div class="container-fluid">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{ route('cau_hoi.danh_sach')}}"> <i class="mdi mdi-comment-question-outline"></i>Câu hỏi</a>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ route('nguoi_choi.danh_sach')}}"> <i class="mdi mdi-gamepad-variant"></i>Người chơi</a>

                            </li>

                            <li class="has-submenu">
                                <a href="{{ route('goi_credit.danh_sach')}}">
                                    <i class="la la-diamond"></i>Gói credit</a>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ route('lich_su_mua_credit')}}"> <i class="mdi mdi-history"></i>Lịch sử mua credit</a>
                            </li>
