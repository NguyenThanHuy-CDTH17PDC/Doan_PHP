...
@section('main-content')
	<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                	<h1 class="mb-3 header-title">Danh sách câu hỏi của trò chơi</h1>
                	<a href="{{ route('cau_hoi.them_moi')}}" class="btn btn-primary btn-rounded waves-effect waves-light">Thêm câu hỏi</a>
